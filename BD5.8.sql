...
CREATE TABLE `alquiler` (
  ...
  CONSTRAINT `alquiler_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`),
  CONSTRAINT `alquiler_ibfk_2` FOREIGN KEY (`idPelicula`) REFERENCES `pelicula` (`idPelicula`)
...
INSERT INTO `alquiler` VALUES (1,1,6,'2025-11-30','2025-12-07'),(2,1,9,'2025-11-30','2025-12-07'),(3,1,20,'2025-11-30','2025-12-07'),(4,1,22,'2025-11-30','2025-12-07'),(5,1,26,'2025-11-30','2025-12-07'),(6,1,38,'2025-11-30','2025-12-07'),(7,6,9,'2026-01-15','2026-01-22'),(8,6,6,'2026-01-15','2026-01-22');
...
CREATE TABLE `favoritos` (
  ...
  KEY `favoritos_ibfk_2` (`idPelicula`),
...
INSERT INTO `favoritos` VALUES (1,3),(6,3),(1,6),(1,11),(6,17),(1,18),(1,22),(1,29),(1,34),(1,50);
...
CREATE TABLE `pedido` (
  ...
  KEY `idPelicula` (`idPelicula`),
  CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`idPelicula`) REFERENCES `pelicula` (`idPelicula`)
...
INSERT INTO `pedido` VALUES (2,'2026-01-15','2026-01-22','Pagado',5,'','admin@gmail.com'),(3,'2026-01-15','2026-01-22','Pagado',5,'','admin@gmail.com'),(4,'2026-01-15','2026-01-22','Pagado',5,'','admin@gmail.com'),(5,'2026-01-15','2026-01-22','Pagado',5,'','admin@gmail.com'),(6,'2026-01-15','2026-01-22','Pendiente',5,'','admin@gmail.com'),(8,'2026-01-15','2026-01-22','pagado',3,'','admin@gmail.com'),(9,'2026-01-17','2026-01-24','Pendiente',3,'','admin@gmail.com'),(10,'2026-01-19','2026-01-26','Pendiente',3,'','admin@gmail.com'),(11,'2026-01-19','2026-01-26','Pendiente',3,'','admin@gmail.com'),(12,'2026-01-19','2026-01-26','Pendiente',5,'','admin@gmail.com'),(13,'2026-01-19','2026-01-26','Pendiente',11,'','admin@gmail.com'),(14,'2026-01-19','2026-01-26','Pendiente',13,'','admin@gmail.com');
...
INSERT INTO `usuario` VALUES (1,'1','1','1',5,100.00),(3,'1','1','1',NULL,0.00),(4,'12345678@','12345678','12345678@',NULL,9.07),(5,'12345678@','12345678','12345678@',NULL,100.00),(6,'123456789@','scghkjyu','123456789@',NULL,13520054.02);
...
-- Dump completed on 2026-01-19 19:40:51
